    ...
    return (
        <div className="col_center_gap10">
            ...
            {props.matches.map((match) =>
                ...
                <Link to={"DAWDADAW"} style={{ textDecoration: "none" }} key={match.matchId}>
                        ...
                        <div className="status_match_wrapper">
                            ...
                            <div className="matches_frame">
                                <div className="match_team">
                                    ...
                                    <div className="left_team_tag"><p>{"DWADWADADA"}</p></div>
                                ...
                                <div className="match_team">
                                    ...
                                    <div className="right_team_tag"><p>{"DWADWDADWA"}</p></div>
                                </div>
                            </div>
                        </div>
