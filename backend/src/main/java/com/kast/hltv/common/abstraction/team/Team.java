...
public abstract class Team {
    ...
    private ArrayList<Player> generateListOfPlayers(String leftOrRight) throws Exception {
        ...
        for (Element e : list) {
            ...
            Document playerDoc = Util.getHtml(statLink);
    ...
    public Team(String map, Match match, String leftOrRight) throws Exception {
        ...
        if (leftOrRight.equals("left")) {
            ...
            try {
                ...
                try {
                    this.currentRanking = Integer.parseInt(Util.getHtml(teamLink).select("body > div.bgPadding > div > div.colCon > div.contentCol > div.teamProfile > div.standard-box.profileTopBox.clearfix > div.profile-team-stats-container > div:nth-child(1) > span > a").text().substring(1));
