package com.kast.hltv.common.image;

import com.kast.hltv.common.abstraction.match.Match;
import com.kast.hltv.common.image.html2image.image.HtmlImageGenerator;
    ...
    private static void imageWriter(String TeamName, String ImageLink, Match match, int leftOrRight) throws IOException {
        try {
            ...
            if (el1.isEmpty()) {
                ...
                a1 = String.valueOf(el1.getFirst());
            }
            ...
            String a1 = String.valueOf(el1.getFirst());
