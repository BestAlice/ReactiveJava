...
public class Player {
    ...
    public Player(@NotNull Document playerDoc) {
        ...
        try {
            openingKillRatio = Double.parseDouble(Util.getHtml("https://www.hltv.org" + playerDoc.select("body > div.bgPadding > div > div.colCon > div.contentCol > div.stats-section.stats-player.stats-player-overview > div.gtSmartphone-only > div > div > a:nth-child(2)")
